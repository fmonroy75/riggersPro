  ...
  <div class="home">
    <div class="top-bar">
      <div v-if="user" class="user-info">
        ...
        <button class="auth-btn" @click="handleLogout">{{ $t('home.logout') }}</button>
      </div>
      <div v-else class="auth-actions">
        <button class="auth-btn" @click="router.push('/login')">{{ $t('home.login_pro') }}</button>
      </div>
    </div>
    ...
    <h2 class="section-title">{{ $t('home.standard_tools') }}</h2>
    <div class="grid">
      <div
      ...
      >
        ...
        <div class="name">{{ $t(`calc_names["${calc.name}"]`) || calc.name }}</div>
      </div>
    </div>

    <!-- PRO CALCULATORS -->
    <h2 class="section-title pro-title">{{ $t('home.pro_tools') }}</h2>
    <div class="grid pro-grid">
      ...
      >
        ...
        <div class="name">
          {{ $t(`calc_names["${calc.name}"]`) || calc.name }}
    ...
    <footer class="home-footer">
      <p>{{ $t('home.contact_us') }} <a href="mailto:info@ingeniumbright.com">info@ingeniumbright.com</a></p>
